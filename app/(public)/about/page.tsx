...
const team = [
  {
    name: "Dr. Ayesha Khan",
    role: "CEO & Co-Founder",
    bio: "Former healthcare consultant with 15 years in Pakistan's health sector.",
    image: "AK",
  },
  {
    name: "Ahmed Hassan",
    role: "CTO & Co-Founder",
    bio: "AI researcher and serial entrepreneur with expertise in ML systems.",
    image: "AH",
  },
  {
    name: "Sara Malik",
    role: "Head of Product",
    bio: "Product leader passionate about healthcare accessibility.",
    image: "SM",
  },
  {
    name: "Dr. Usman Ali",
    role: "Healthcare Advisor",
    bio: "Psychiatrist and mental health advocate in Pakistan.",
    image: "UA",
  },
];

const milestones = [
  { year: "2023", event: "MedValidateAI founded in Karachi" },
  { year: "2023", event: "First 100 startups validated" },
  { year: "2024", event: "AI engine v2.0 launched with local market data" },
  { year: "2024", event: "Partnered with 10+ Pakistani health accelerators" },
  { year: "2025", event: "Expanding to mental health specialization" },
];
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map((member, i) => (
              ...
              >
                <div className="w-24 h-24 rounded-full gradient-primary flex items-center justify-center mx-auto mb-4 text-2xl font-display font-bold text-white">
                  {member.image}
                </div>
